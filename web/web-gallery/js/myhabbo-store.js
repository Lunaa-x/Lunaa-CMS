var WebStore = {
  ...
  _loadMainContent: function(tab) {
    if (tab == "webstore-inventory") {
      ...
      new Ajax.Request(
        habboReqPath + "habblet/myhabbo_store.php?key=main", {
          method: "post",
      ...
      try {
        if (el.id == "webstore-purchase-disabled") {
          ...
          if (!WebStore.backgroundPreviewWarning) {
            ...
            new Ajax.Request(habboReqPath + "habblet/myhabbo_store.php?key=background_warning", {
                method: "post",
  ...
  _loadSubCategory: function(categoryId, subCategoryId, productId) {
    ...
    new Ajax.Request(
      habboReqPath + "habblet/myhabbo_store.php?key=items", {
  ...
  _loadPreview: function(productId) {
    ...
    WebStore._showPreview();
    new Ajax.Request(
      habboReqPath + "habblet/myhabbo_store.php?key=preview", {
  ...
  _purchaseConfirm: function(productId) {
    ...
    new Ajax.Request(habboReqPath + "habblet/myhabbo_store.php?key=purchase_confirm", { 
      method: "post", parameters: { "productId" : productId, "subCategoryId" :  WebStore.selectedSubCategory }, 
      onComplete: function(req, json) {
        if (WebStore._checkResponse(req.responseText)) {
  ...
  _purchase: function(productId, dialog) {
    ...
    new Ajax.Request(habboReqPath + "habblet/myhabbo_store.php?key=purchase_" + type, { 
...
WebStore.Inventory = {
  ...
  load: function() {
    new Ajax.Request(
      habboReqPath + "habblet/myhabbo_store.php?key=inventory", {
  ...
  loadCategory: function(type) {
    if (!WebStore.Inventory.loadingCategory) {
      ...
      new Ajax.Request(
        habboReqPath + "habblet/myhabbo_store.php?key=inventory_items", {
  ...
  _loadPreview: function(itemId, type, privileged) {
    ...
    new Ajax.Request(
      habboReqPath + "habblet/myhabbo_store.php?key=inventory_preview", {
...
WebStore.StickerEditor = {
  ...
  open: function() {
    new Ajax.Request(
      habboReqPath + "habblet/myhabbo_store.php?key=stickereditor_flash", {
  ...
  preview: function(figureParams) {
    ...
    new Ajax.Request(habboReqPath + "habblet/myhabbo_store.php?key=preview", {
  ...
  _purchase: function(imageUrl) {
    new Ajax.Request(habboReqPath + "habblet/myhabbo_store.php?key=purchase_avatarsticker", {
...
WebStore.NoteEditor = {
  ...
  _loadEditor: function(noteParams, backFromPreview) {
    ...
    new Ajax.Request(habboReqPath + "habblet/myhabbo_store.php?key=noteeditor", {
            ...
            if (WebStore._checkResponse(req.responseText)) {
              ...
              if ($("webstore-notes-continue")) { Event.observe($("webstore-notes-continue"), "click", function(e) {
                ...
                if (!el.className || !Element.hasClassName(el, "disabled-button")) {
                  ...
                  Dialog.setAsWaitDialog(WebStore.NoteEditor.dialog);
                  new Ajax.Request(habboReqPath + "habblet/myhabbo_store.php?key=noteeditor-preview", {
                    method: "post", parameters: WebStore.NoteEditor.noteParams, onComplete: function(req, json) {
                      if (WebStore._checkResponse(req.responseText)) {
  ...
  _place: function() {
    if (WebStore.NoteEditor.noteParams) {
      new Ajax.Request(habboReqPath + "habblet/myhabbo_store.php?key=noteeditor-place", {
        method: "post", parameters: WebStore.NoteEditor.noteParams, onComplete: function(req, json) {
          if (WebStore._checkResponse(req.responseText)) {
            if (req.responseText.strip() == "BACK") {
              WebStore.NoteEditor._loadEditor(WebStore.NoteEditor.noteParams, true);
  ...
  _saveChanges: function() {
    if (WebStore.NoteEditor.noteParams) {
      new Ajax.Request(habboReqPath + "habblet/myhabbo_store.php?key=noteeditor-save", {
        method: "post", parameters: WebStore.NoteEditor.noteParams, onComplete: function(req, json) {
          if (WebStore._checkResponse(req.responseText)) {
            if (req.responseText.strip() == "BACK") {
              WebStore.NoteEditor._loadEditor(WebStore.NoteEditor.noteParams, true);
